...
export const badgeTheme = {
    ...
    color: {
        base: {
            ...
            secondary: 'bg-metal-50 hover:bg-metal-100 text-metal-900 dark:bg-metal-900 dark:hover:bg-metal-900/75 dark:text-white',
...
const badgeVariants = ({ color = 'secondary', variant = 'background' } = {}) => {
