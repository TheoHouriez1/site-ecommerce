...
const FAQPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Oui, la livraison est entièrement gratuite pour toutes les commandes effectuées sur notre site, sans minimum d achat. Que vous commandiez un seul article ou plusieurs, nous prenons en charge les frais de livraison pour vous offrir une expérience d’achat simple, rapide et sans surprise. Profitez-en dès maintenant !'
    },
    {
      id: 'q7',
      category: 'payment',
      question: 'Quels modes de paiement acceptez-vous ?',
      answer: 'Nous acceptons les modes de paiement suivants :\n- Cartes de crédit (Visa, Mastercard, American Express)(pour les commandes supérieures à 200€)\nToutes les transactions sont sécurisées et vos informations de paiement sont chiffrées.'
    },
    {
      id: 'q8',
      category: 'payment',
